...
function [sigma_0_vv, sigma_0_vv_canopy, sigma_0_vv_gcg, sigma_0_vv_gc] = S2RTR_DiffuseUB2_aKe(eps_v_r, eps_v_i, a, d, f, s,  kappa_e,  theta)
...
sigma_0_vv_gcg = 0.75*a * cos(theta_r) .*(1- T.^2).*gammav.^2 .* T.^2;

% sigma_0_vv_gcg = 0.75./kappa_e.*kappa_s*cos(theta_r).*(1- T.^2).*gammav.^2.* T.^2;
